        ...
        <div class="login-form">
            <form>
                ...
                <input
                    ...
                    autocomplete="off"
                /><br /><br />
                <div class="error-notice" id="user-error">
                    <br />
                </div>
                <label>
                    <i class="bx bx-user"></i>
                ...
                <input
                    ...
                    autocomplete="off"
                /><br /><br />
                <div class="error-notice" id="pass-error">
                    <br />
                </div>
            </form>
            <button class="btn btn-black" id="login-btn" onclick='submitFunction'>
                Login
            </button>
            <button
                class="btn btn-secondary"
                onclick="location.href='http://localhost:3000/signup/'"
                >
                Register
            </button>
        </div>, document.getElementById('login-dropdown')
    )
}
else {
    console.log(userInfo, 1)
    ReactDOM.render(<UserProfile userInfo={userInfo}/>, document.getElementById('login-dropdown'));
