...
const HomePage = (props) => {
    ...
    return (
        (thumbnailSrcDict !== null ) &&<Container>
            ...
            <Row className="basic-article-group"> 
                ...
                <Col sm="8">
                    ...
                    <Row className="wow fadeInRight center-row" id="intro-section-3" >
                        ...
                        <Col sm="7">
                            <img src={thumbnailSrcDict["jump-1"]["article-3"]["thumbnail"]}  alt="Sir Alex" className="article-thumbnail w-100"/>
                        </Col>
                    </Row>
                    ...
                    <Row className="wow fadeInLeft center-row" id="intro-section-4" >
                        <Col sm="7">
                            <img src={thumbnailSrcDict["jump-1"]["article-4"]["thumbnail"]}  alt="ManUtd No7" className="article-thumbnail w-100" ref={articleRef4}/>
                        </Col>
                        <Col sm="5">
