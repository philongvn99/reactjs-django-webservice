    ...
    return (
        <Container>
            ...
            <Row className="jump-section-1">
                {(thumbnailSrcDict !== null )&&<Col sm="3" className="wow fadeInUp jump-col"><button className="jump-button" onClick={() => executeScroll(articleRef1)}><img src={thumbnailSrcDict["jump-1"]["article-1"]["mini-thumbnail"]} alt="jump-1-1" ></img></button></Col>}
                {(thumbnailSrcDict !== null )&&<Col sm="3" className="wow fadeInDown jump-col"><button className="jump-button" onClick={() => executeScroll(articleRef2)}><img src={thumbnailSrcDict["jump-1"]["article-2"]["mini-thumbnail"]} alt="jump-1-2" ></img></button></Col>}
                {(thumbnailSrcDict !== null )&&<Col sm="3" className="wow fadeInDown jump-col"><button className="jump-button" onClick={() => executeScroll(articleRef3)}><img src={thumbnailSrcDict["jump-1"]["article-3"]["mini-thumbnail"]} alt="jump-1-2" ></img></button></Col>}
                {(thumbnailSrcDict !== null )&&<Col sm="3" className="wow fadeInUp jump-col"><button className="jump-button" onClick={() => executeScroll(articleRef4)}><img src={thumbnailSrcDict["jump-1"]["article-4"]["mini-thumbnail"]} alt="jump-1-1" ></img></button></Col>}
            </Row>
            <Row className="basic-article-group"> 
                ...
                <Col sm="8">
                    ...
                    <Row className="wow fadeInRight center-row" id="intro-section-1" >
                        ...
                        <Col sm="7">
                            {(thumbnailSrcDict !== null )&&<img src={thumbnailSrcDict["jump-1"]["article-1"]["thumbnail"]}  alt="United" className="article-thumbnail w-100"/>}
                        </Col>
                    </Row>
                    ...
                    <Row className="wow fadeInLeft center-row" id="intro-section-2" >
                        <Col sm="7">
                            {(thumbnailSrcDict !== null )&&<img src={thumbnailSrcDict["jump-1"]["article-2"]["mini-thumbnail"]}  alt="Old Trafford" className="article-thumbnail w-100"/>}
                        </Col>
                        <Col sm="5">
                    ...
                    <Row className="wow fadeInRight center-row" id="intro-section-3" >
                        ...
                        <Col sm="7">
                            {(thumbnailSrcDict !== null )&&<img src={thumbnailSrcDict["jump-1"]["article-3"]["thumbnail"]}  alt="Sir Alex" className="article-thumbnail w-100"/>}
                        </Col>
                    </Row>
                    ...
                    <Row className="wow fadeInLeft center-row" id="intro-section-4" >
                        <Col sm="7">
                            {(thumbnailSrcDict !== null )&&<img src={thumbnailSrcDict["jump-1"]["article-4"]["thumbnail"]}  alt="ManUtd No7" className="article-thumbnail w-100" ref={articleRef4}/>}
                        </Col>
                        <Col sm="5">
