        ...
        <div id="signup-background">
            <div id="signup-form">
                ...
                <div className="submit-signup-field">
                    <label htmlFor="UserName">{userInfo.username}</label>
                    <input 
                        id="signup-username"
                        type="text"
                ...
                <div className="submit-signup-field">
                    <label htmlFor="Phone Number">{userInfo.name}</label>
                    <input 
                        id="signup-phone"
                        type="number"
                ...
                <div className="submit-signup-field">
                    <label htmlFor="Password">{userInfo.password}</label>
                    <input 
                        id="signup-password" 
                        type="text" 
                ...
                <div className="submit-signup-field">
                    <label htmlFor="Confirm Password">{userInfo.c_password}</label>
                    <input 
